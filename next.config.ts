...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      "default-src 'self'",
      // Development tooling needs eval; production chunks do not.
      `script-src 'self' 'unsafe-inline' ${process.env.NODE_ENV === "production" ? "" : "'unsafe-eval' "}https://www.youtube.com https://s.ytimg.com`,
